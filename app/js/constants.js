// js/constants.js
export const METODOS_DE_PAGO = ['Efectivo', 'Nequi', 'Davivienda'];
export const ESTADOS_REMISION = ['Recibido', 'En Proceso', 'Procesado', 'Entregado'];
export const ALL_MODULES = ['remisiones', 'facturacion', 'clientes', 'items', 'colores', 'gastos', 'proveedores', 'prestamos', 'empleados', 'mensajes', 'nomina'];
